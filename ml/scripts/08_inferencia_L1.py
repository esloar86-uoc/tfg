...
L1_PATH = ROOT / "data" / "lotes" / "L1_manual_cat.csv"

# Carpeta del experimento E1 donde está el SVM ganador
RUN_E1 = ROOT / "resultados" / "experimentos" / "20251111_130612_baselines"

MODEL_PATH = RUN_E1 / "E1_texto_svm" / "model.joblib"
LABELS_PATH = RUN_E1 / "labels.json"

# Carpeta de salida para este lote
OUT_DIR = ROOT / "resultados" / "lotes" / "L1_SVM_v1"
OUT_DIR.mkdir(parents=True, exist_ok=True)

#------------------------
# 1) Cargar datos de L1
#------------------------
print(f"Leyendo CSV de L1 desde: {L1_PATH}")
df = pd.read_csv(L1_PATH, sep=";", encoding="utf-8")

# Asegurar nombres
if "resumen" not in df.columns or "descripcion" not in df.columns:
    raise ValueError("No encuentro columnas 'resumen' y 'descripcion' en L1_manual_cat.csv")

if "categoria" not in df.columns:
    raise ValueError("No encuentro columna 'categoria' (etiqueta real) en L1_manual_cat.csv")
...
report_path = OUT_DIR / "L1_report_v1_0.txt"
...
plt.title("Matriz de confusión — L1 vs SVM E1 (normalizada)")
plt.xlabel("Predicha")
plt.ylabel("Real")
...
cm_path = OUT_DIR / "L1_confusion_v1_0.png"
...
#----------------------------------
pred_path = OUT_DIR / "L1_predicciones_v1_0.csv"
...
print("\nLote L1 procesado correctamente.")
