...
CSV_L3 = ROOT / "data" / "lotes" / "L3_manual_cat.csv"
...
OUT_DIR = ROOT / "resultados" / "lotes" / "L3_SVM_v1_1"
OUT_DIR.mkdir(parents=True, exist_ok=True)

#----------------------
# 1) Cargar datos de L3
#----------------------
print(f"Leyendo CSV de L3 desde: {CSV_L3}")
df = pd.read_csv(CSV_L3, sep=";", encoding="utf-8")

# Comprobaciones mínimas
for col in ("resumen", "descripcion", "categoria"):
    if col not in df.columns:
        raise ValueError(f"No se encuentra la columna '{col}' en L3_manual_cat.csv")
...
print("Ejemplo de texto y etiqueta real en L3:")
...
print("Lanzando predicciones sobre L3...")
...
print("Primeras predicciones en L3:")
...
report_path = OUT_DIR / "L3_report_v1_1.txt"
...
cm_path = OUT_DIR / "L3_confusion_v1_1.png"
...
#----------------------------------
pred_path = OUT_DIR / "L3_predicciones_v1_1.csv"
...
print("\nLote L3 procesado con el modelo v1.1.")